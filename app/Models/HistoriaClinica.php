...
class HistoriaClinica extends Model
{
    ...
    protected $fillable = ['paciente_id', 'datosocioeconomico_id', 'historia_desarrollo_id', 'antecedente_medico_id','historia_escolar_id', 'codigo', 'referencia', 'especialista_refirio', 'motivo'];
