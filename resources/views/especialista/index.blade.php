...
@section('content')
                      ...
                      <div id="paso1">
                        ...
                        <div class="fila-formulario">
                          ...
                          <div class="form-grup col-md-6">
                            <select class="form-control select2" required style="width: 100%;" id="especialidad_id"
  ...
  <div class="modal fade" id="especialidadModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        $.ajax({
          ...
          success: function(response) {
            toastr.success(response.message, 'Éxito', {
              timeOut: 5000
            }); // Usar toastr para mostrar el mensaje
            $('#especialidadModal').modal('hide');
            location.reload(); // Recargar la página
          },
          error: function(xhr) {
            toastr.error('Error al registrar la especialidad: ' + xhr.responseText, 'Error', {
              timeOut: 5000
            });
          }
        });
