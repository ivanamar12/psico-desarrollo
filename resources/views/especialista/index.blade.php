            ...
            <div class="modal-content">
                ...
                <form id="edit-especialista-form">
					...
					<input type="hidden" id="id" name="id">
													...
													<div class="form-group label-floating">
														<label class="control-label">Especialidad</label>
														<input class="form-control" id="especialidad2" name="especialidad2" type="text">
													</div>
													<div class="form-group label-floating">
														<label class="control-label">Telefono</label>
...
<script>
function mostrarespecialista(id) {
    $.get('/especialista/' + id, function(data) {
        $('#nombre').text(data.nombre + ' ' + data.apellido); 
        $('#ci').text(data.ci);
        $('#fecha_nac').text(data.fecha_nac);
