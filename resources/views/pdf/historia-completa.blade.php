...
<body>
    ...
    <div class="container">
        ...
        <table>
            ...
            <tr>
                <td><span>Nombre:</span> {{ $historia->paciente->representante->nombre }} {{ $historia->paciente->representante->apellido }}</td>
        ...
        <table>
            <tr>
                ...
                <td><span>Cantidad de Habitaciones:</span> {{ $historia->paciente->datosEconomico->cantidad_habitaciones }}</td>
            </tr>
            <tr>
                <td><span>Cantidad de Personas en la Vivienda:</span> {{ $historia->paciente->datosEconomico->cantidad_personas }}</td>
                <td><span>Servicio de Agua Potable:</span> {{ $historia->paciente->datosEconomico->servecio_agua_potable }}</td>
            </tr>
            <tr>
                <td><span>Servicio de Gas:</span> {{ $historia->paciente->datosEconomico->servecio_gas }}</td>
                <td><span>Servicio de Electricidad:</span> {{ $historia->paciente->datosEconomico->servecio_electricidad }}</td>
            </tr>
            <tr>
                <td><span>Servicio de Drenaje:</span> {{ $historia->paciente->datosEconomico->servecio_drenaje }}</td>
                <td><span>Disponibilidad de Internet:</span> {{ $historia->paciente->datosEconomico->disponibilidad_internet }}</td>
            </tr>
            <tr>
                <td><span>Tipo de Conexión a Internet:</span> {{ $historia->paciente->datosEconomico->tipo_conexion_internet }}</td>
                <td><span>Acceso a Servicios Públicos:</span> {{ $historia->paciente->datosEconomico->acceso_servcios_publicos }}</td>
            </tr>
            <tr>
                <td><span>Fuente de Ingreso Familiar:</span> {{ $historia->paciente->datosEconomico->fuente_ingreso_familiar }}</td>
                <td><span>Observaciones:</span> {{ $historia->paciente->datosEconomico->observacion ?: 'Sin observaciones' }}</td>
            </tr>
        </table>
                <!-- Parentescos -->
        ...
        <table>
            <tr>
                ...
                <td><span>Tipo de Enfermedad Infecciosa:</span> {{ $historia->antecedenteMedico->tipo_enfermedad_infecciosa }}</td>
            </tr>
            <tr>
                <td><span>Enfermedad No Infecciosa:</span> {{ $historia->antecedenteMedico->enfermedad_no_infecciosa }}</td>
                <td><span>Tipo de Enfermedad No Infecciosa:</span> {{ $historia->antecedenteMedico->tipo_enfermedad_no_infecciosa }}</td>
            </tr>
            <tr>
        ...
        <table>
            <tr>
                <td><span>Medicamentos durante el embarazo:</span> {{ $historia->historiaDesarrollo->medicamento_embarazo }}</td>
            ...
            <tr>
                <td><span>Cantidad de alcohol consumida:</span> {{ $historia->historiaDesarrollo->cantidad_consumia_alcohol }}</td>
            ...
            <tr>
                <td><span>Tipo de Problema de Alimentación:</span> {{ $historia->historiaDesarrollo->tipo_problema_alimenticio }}</td>
            ...
            <tr>
                ...
                <td><span>El niño era tranquilo recién nacido:</span> {{ $historia->historiaDesarrollo->tranquilo_recien_nacido }}</td>
            </tr>
            <tr>
                <td><span>Le gustaba que lo cargaran recién nacido:</span> {{ $historia->historiaDesarrollo->gustaba_cargaran_recien_nacido }}</td>
                <td><span>El niño era alerta recién nacido:</span> {{ $historia->historiaDesarrollo->alerta_recien_nacido }}</td>
            </tr>
            <tr>
                <td><span>Problemas de desarrollo en los primeros años:</span> {{ $historia->historiaDesarrollo->problemas_desarrollo_primeros_años }}</td>
                <td><span>¿Cuáles problemas?:</span> {{ $historia->historiaDesarrollo->cuales_problemas }}</td>
            </tr>
            <tr>
                <td colspan="2"><span>Observaciones:</span> {{ $historia->historiaDesarrollo->observacion ?: 'Sin observaciones' }}</td>
            </tr>
        </table>
        <!-- Historia Escolar -->
        ...
        <table>
            ...
            <tr>
                <td colspan="2"><span>Observaciones:</span> {{ $historia->historiaEscolar->observacion ?: 'Sin observaciones' }}</td>
            </tr>
        </table>
    </div>
</body>