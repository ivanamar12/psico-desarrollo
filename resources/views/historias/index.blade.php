                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-xs-12 col-md-10 col-md-offset-1">
                                    <form id="registro-historia">@csrf
                                        <section id="paso1">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    <label class="control-label">Paciente <span
                                                            class="text-danger">*</span></label>
                                                    <select class="form-control form-control-solid select2" required
                                                        style="width: 100%;" id="paciente_id" name="paciente_id">
                                                ...
                                                <!-- Código de Historia -->
                                                <div class="form-group label-floating col-md-6">
                                                    <label class="control-label">Código de Historia <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" readonly id="codigo"
                                                        name="codigo" placeholder="Código" required
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    <label class="control-label">Especialidad que Refirió <span
                                                            class="text-danger">*</span></label>
                                                    <input class="form-control" id="especialista_refirio"
                                                        name="especialista_refirio" type="text" required>
                                        ...
                                        <section id="paso2">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>¿El niño ha sufrido de alguna enfermedad infecciosa? <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label class="mr-2">
                                                            <input type="radio" name="enfermedad_infecciosa" value="si"
                                                                required> <span>Sí</span>
                                                        </label>
                                                        <label class="ml-3">
                                                    ...
                                                    <small class="form-text text-muted">Indique si el niño ha tenido
                                                        enfermedades como varicela, sarampión, etc. Especifique si
                                                        responde "Sí".</small>
                                                </div>
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <label class="mr-2">
                                                            <input type="radio" name="enfermedad_no_infecciosa"
                                                                value="si" required> <span>Sí</span>
                                                        </label>
                                                        <label class="ml-3">
                                                            <input type="radio" name="enfermedad_no_infecciosa"
                                                        ...
                                                        <input class="form-control ml-3"
                                                            name="tipo_enfermedad_no_infecciosa"
                                                            id="tipo_enfermedad_no_infecciosa" type="text"
                                                            placeholder="Especificar enfermedad no infecciosa">
                                                    </div>
                                                    <small class="form-text text-muted">Ejemplos: alergias, epilepsia,
                                                        asma. Especifique si responde "Sí".</small>
                                                </div>

                                                <!-- Enfermedad Crónica -->
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>¿El niño padece de alguna enfermedad crónica? <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label class="mr-2">
                                                            <input type="radio" name="enfermedad_cronica" value="si"
                                                                required> <span>Sí</span>
                                                        </label>
                                                        <label class="ml-3">
                                                    ...
                                                    <small class="form-text text-muted">Ejemplos: diabetes,
                                                        hipertensión, enfermedades metabólicas. Especifique si responde
                                                        "Sí".</small>
                                                </div>

                                                <!-- Discapacidad -->
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>¿El niño padece de alguna discapacidad? <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label class="mr-2">
                                                        ...
                                                        <input class="form-control ml-3" name="tipo_discapacidad"
                                                            id="tipo_discapacidad" type="text"
                                                            placeholder="Especificar discapacidad">
                                                    </div>
                                                    <small class="form-text text-muted">Ejemplos: visual, auditiva,
                                                        motora, intelectual. Especifique si responde "Sí".</small>
                                                </div>
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    ...
                                                    <input class="form-control" id="otros" name="otros" type="text">
                                                    <small class="form-text text-muted">Ingrese cualquier otro
                                                        antecedente médico relevante que no haya sido mencionado
                                                        anteriormente.</small>
                                                </div>

                                            </div>
                                            <p class="centro-texto">
                                                <button type="button" id="regresar1" class="btn btn-regresar"
                                                    style="color: white;">
                                        ...
                                        <section id="paso3">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>Durante el embarazo ¿la madre recibió algún tipo de medicamento?
                                                        <span class="text-danger">*</span>
                                                    </h5>
                                                    <div class="d-flex align-items-center">
                                                        <label class="mr-2">
                                                            <input type="radio" name="medicamento_embarazo" value="si"
                                                                required>
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                        ...
                                                        <input class="form-control ml-3" id="tipo_medicamento"
                                                            name="tipo_medicamento" type="text"
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>Durante el embarazo ¿la madre fumó? <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label class="mr-2">
                                                            <input type="radio" name="fumo_embarazo" value="si"
                                                                required>
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                        ...
                                                        <input class="form-control ml-3" name="cantidad" id="cantidad"
                                                            type="text" placeholder="Cantidad que fumaba al día">
                                                    </div>
                                                    <small class="text-danger">Este campo es requerido</small>
                                                </div>

                                                <div class="form-group label-floating col-md-6">
                                                    <h5>Durante el embarazo ¿la madre tomó bebidas alcohólicas? <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center flex-wrap">
                                                        <label class="mr-2">
                                                            <input type="radio" name="alcohol_embarazo" value="si"
                                                                required>
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                        ...
                                                        <input class="form-control ml-3 mt-2" style="display: none;"
                                                            name="tipo_alcohol" id="tipo_alcohol" type="text"
                                                            placeholder="Especificar el tipo de alcohol">
                                                        <input class="form-control ml-3 mt-2" style="display: none;"
                                                            name="cantidad_consumia_alcohol"
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>Durante el embarazo ¿la madre utilizó drogas? <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label class="mr-2">
                                                            <input type="radio" name="droga_embarazo" value="si"
                                                                required>
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                        ...
                                                        <input class="form-control ml-3" name="tipo_droga"
                                                            id="tipo_droga" type="text"
                                            ...
                                            <p class="centro-texto">
                                                <button type="button" id="regresar2" class="btn btn-regresar"
                                                    style="color: white;"><i class="zmdi zmdi-arrow-back"></i>
                                                    Regresar</button>
                                        ...
                                        <section id="paso4">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <!-- Fórceps -->
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>¿Se realizaron fórceps durante el parto? <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label class="mr-2">
                                                            <input type="radio" name="forceps_parto" value="si"
                                                                required>
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <label class="mr-2">
                                                            <input type="radio" name="cesarea" value="si" required
                                                                onchange="toggleInput('cesarea', 'razon_cesarea')">
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                        ...
                                                        <input class="form-control ml-3" name="razon_cesarea"
                                                            id="razon_cesarea" type="text"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <label class="mr-2">
                                                            <input type="radio" name="niño_prematuro" value="si"
                                                                required
                                                                onchange="toggleInput('niño_prematuro', 'meses_prematuro')">
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                        ...
                                                        <input class="form-control ml-3" name="meses_prematuro"
                                                            id="meses_prematuro" type="text"
                                                            placeholder="¿Cuántos meses prematuro?"
                                                            style="display: none;">
                                                    </div>
                                                    <small class="text-danger">Campo requerido</small>
                                                </div>
                                                ...
                                                <!-- Complicaciones -->
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>¿Hubo complicaciones en el nacimiento? <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label class="mr-2">
                                                            <input type="radio" name="complicaciones_nacer" value="si"
                                                                required
                                                                onchange="toggleInput('complicaciones_nacer', 'tipo_complicacion')">
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                        ...
                                                        <input class="form-control ml-3" name="tipo_complicacion"
                                                            id="tipo_complicacion" type="text"
                                                            placeholder="Especificar la complicación"
                                                            style="display: none;">
                                                    </div>
                                                    <small class="text-danger">Campo requerido</small>
                                                </div>
                                                ...
                                                <!-- Peso -->
                                                <div class="form-group label-floating col-md-6">
                                                    <label class="control-label">Peso al nacer <span
                                                            class="text-danger">*</span></label>
                                                    <input class="form-control" id="peso_nacer_niño"
                                                        name="peso_nacer_niño" type="text" required>
                                                    <small class="">Ingrese el peso en kilos</small>
                                                </div>

                                            </div>

                                            <p class="centro-texto">
                                                <button type="button" id="regresar3" class="btn btn-regresar"
                                                    style="color: white;">
                                                    <i class="zmdi zmdi-arrow-back"></i> Regresar
                                                </button>
                                        ...
                                        <section id="paso5">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>¿Hubo algún tipo de problema de alimentación? <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label>
                                                        ...
                                                        <input class="form-control mt-2"
                                                            name="tipo_problema_alimenticio"
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>¿El niño tenía problemas para dormir? <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label>
                                                        ...
                                                        <input class="form-control mt-2" name="tipo_problema_dormir"
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>Cuando recién nacido, ¿el niño era tranquilo? <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label>
                                                            <input type="radio" name="tranquilo_recien_nacido"
                                                                value="si" required>
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>Cuando recién nacido, ¿al niño le gustaba que lo cargaran? <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label>
                                                            <input type="radio" name="gustaba_cargaran_recien_nacido"
                                                                value="si" required>
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>Cuando recién nacido, ¿el niño estaba alerta? <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label>
                                                            <input type="radio" name="alerta_recien_nacido" value="si"
                                                                required>
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>¿Hubo algún problema o complicación en el crecimiento y
                                                        desarrollo del niño en los primeros años de vida? <span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label>
                                                            <input type="radio"
                                                                name="problemas_desarrollo_primeros_años" value="si"
                                                                required>
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                            <input type="radio"
                                                                name="problemas_desarrollo_primeros_años" value="no">
                                                            <span>No</span>
                                                        </label>
                                                        <input class="form-control mt-2" name="cuales_problemas"
                                            ...
                                            <p class="centro-texto">
                                                <button type="button" id="regresar4" class="btn btn-regresar"
                                                    style="color: white;">
                                                    <i class="zmdi zmdi-arrow-back"></i> Regresar
                                                </button>
                                        ...
                                        <section id="paso6">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>¿El niño está escolarizado?<span class="text-danger">*</span>
                                                    </h5>
                                                    <div class="d-flex align-items-center">
                                                        <label>
                                                        ...
                                                        <input class="form-control" name="tipo_educaion"
                                                            id="tipo_educaion" type="text"
                                                            placeholder="Especificar el tipo de educación que recibe el niño">
                                                    </div>
                                                </div>

                                                <div class="form-group label-floating col-md-6">
                                                    <h5>¿Recibe alguna terapia o tutoría?<span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label>
                                                            <input type="radio" name="tutoria_terapias" value="si"
                                                                required>
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                        ...
                                                        <input class="form-control" name="tutoria_terapias_cuales"
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>¿El niño presenta alguna dificultad para la lectura?<span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label>
                                                            <input type="radio" name="dificultad_lectura" value="si"
                                                                required>
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>¿El niño presenta alguna dificultad para la aritmética?<span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label>
                                                            <input type="radio" name="dificultad_aritmetica" value="si"
                                                                required>
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>¿El niño presenta alguna dificultad para la escritura?<span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label>
                                                            <input type="radio" name="dificultad_escribir" value="si"
                                                                required>
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                                ...
                                                <div class="form-group label-floating col-md-6">
                                                    <h5>¿Le agrada el ambiente escolar?<span
                                                            class="text-danger">*</span></h5>
                                                    <div class="d-flex align-items-center">
                                                        <label>
                                                            <input type="radio" name="agrada_escuela" value="si"
                                                                required>
                                                            <span>Si</span>
                                                        </label>
                                                        <label>
                                            ...
                                            <p class="centro-texto">
                                                <button type="button" id="regresar5" class="btn btn-regresar"
                                                    style="color: white;">
                                                    <i class="zmdi zmdi-arrow-back"></i> Regresar
                                                </button>
                                                <button type="submit" name="registrar" class="btn btn-custom"
                                                    style="color: white;">
        ...
        ajax: {
            transport: function (params, success) {
                ...
                const results = filtrados.map(function (p) {
                    return { id: p.id, text: `${p.nombre} ${p.apellido} (${p.id})` };
                });
...
$(function () {
    ...
    $peso.on('paste', function (e) { e.preventDefault(); });
