...
<head>
  ...
  <title>Recuperación de Contraseña - PsicoDesarrollo</title>
  ...
  <main style="min-height: 91vh;">
    <section style="height: 85vh; display: flex; justify-content: center; align-items: center">
      <div class="modal-content">
        ...
        <p>
          Ingresa el correo electrónico asociado a tu cuenta para continuar con el proceso:
        </p>
        ...
        <form method="POST" action="{{ route('password.email') }}">
          ...
          <div style="margin: 12px 0px">
            Verificaremos tu identidad mediante tu pregunta de seguridad registrada.
          </div>
