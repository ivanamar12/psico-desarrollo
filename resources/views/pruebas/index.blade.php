										...
										<div id="paso1">
											...
											<div class="fila-formulario">
												...
												<div class="form-grup col-md-6">
                                                    <select class="form-control select2" required style="width: 100%;" id="rango_edad" name="rango_edad">
                                                ...
                                                <div class="form-grup col-md-6">
                                                    <select class="form-control select2" required style="width: 100%;" id="area_desarrollo" name="area_desarrollo">
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    toastr.success(response.message, 'Exito', { timeOut: 5000 });
                }
...
$('#btnEliminar').click(function(){
    $.ajax({
        ...
        success: function(data){
            ...
            toastr.warning('La prueba se eliminó correctamente', 'Eliminar Prueba', { timeOut: 5000 });
            $('#tab-prueba').DataTable().ajax.reload();
        },
        error: function(xhr, status, error) {
            console.error('Error al eliminar la prueba:', error);
            toastr.error('No se pudo eliminar la prueba', 'Error', { timeOut: 5000 });
        }
    });
});
</script>
