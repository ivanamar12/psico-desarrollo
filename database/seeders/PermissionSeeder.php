    ...
    public function run()
    {
        ...
        if ($admin) {
            $admin->givePermissionTo([
                'crear citas', 'cambiar estado citas', 'ver citas', 'descargar citas',
                'registrar especialista', 'editar especialista', 'eliminar especialista', 'ver especialista',
                ...
                'crear historia', 'eliminar historia', 'descargar historia', 'editar historia', 'descargar informe', 'bitacora','usuarios'
            ]);
        }

        if ($secretaria) {
            $secretaria->givePermissionTo([
                'crear citas', 'ver citas', 'descargar citas', 'cambiar estado citas',
                'editar especialista', 'ver especialista',
                'registrar representante', 'editar representante', 'ver representante', 'eliminar representante',
                'registrar paciente', 'editar paciente', 'eliminar paciente', 'ver paciente',
                'descargar historia', 'descargar informe'
            ]);
        }

        if ($especialista) {
            $especialista->givePermissionTo([
                'ver citas', 'descargar citas', 'cambiar estado citas',
                'ver representante', 'ver paciente',
                'crear historia', 'descargar historia', 'editar historia',
                'registrar prueba', 'editar prueba', 'eliminar prueba', 'descargar prueba', 'ver prueba',
                'aplicar prueba', 'descargar informe', 'pruebas'
            ]);
        }
    }
}
