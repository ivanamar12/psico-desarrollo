...
class CreateLenguajeExpresivosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lenguaje_expresivos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('lenguaje_expresivos');
    }
}
