...
class CreateLenguajeArticulatoriosTable extends Migration
{
    
    public function up()
    {
        Schema::create('lenguaje_articulatorios', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('lenguaje_articulatorios');
    }
}
