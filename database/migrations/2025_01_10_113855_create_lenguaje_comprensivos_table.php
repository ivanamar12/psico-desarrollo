...
class CreateLenguajeComprensivosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lenguaje_comprensivos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('lenguaje_comprensivos');
    }
}
