...
class CreateEstructuracionEsapacialsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('estructuracion_esapacials', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('estructuracion_esapacials');
    }
}
