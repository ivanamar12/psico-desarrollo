...
class CreatePsicomotricidadCumaninsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('psicomotricidad_cumanins', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('psicomotricidad_cumanins');
    }
}
