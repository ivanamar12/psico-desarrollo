...
class CreateDesarrolloNoVerbalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('desarrollo_no_verbals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('desarrollo_no_verbals');
    }
}
